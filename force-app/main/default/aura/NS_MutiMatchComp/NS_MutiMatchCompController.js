({ // init
    init: function (component, event, helper) {
        ...
        if(ANI !== undefined && ANI !== ""){
            helper.getAccDataInit(component);
            /**** Commented by SUdipto G for the Static Issue */
            /*helper.setPhoneNumber(component);
            helper.runMatchLogic(component);
            if(!component.get('v.ShowNoRecordModal')){
                console.log('init -- NS_MultiMatchCompController --BEFORE ');
                helper.getAccData(component);
                console.log('init -- NS_MultiMatchCompController --AFTER ');
            }
            */
        }
    },
