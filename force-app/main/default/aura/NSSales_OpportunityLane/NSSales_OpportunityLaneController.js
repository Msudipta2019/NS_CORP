({
	fetchopplane : function(component, event, helper) {
        component.set('v.mycolumns', [
            ...
            {label: 'STCC', fieldName: 'NSSales_STCC__c', type: 'text'},
            ...
            {label: '1st Offer Rate', fieldName: 'NSSales_Round_1_Rate__c', type: 'text'},
            {label: 'Final Offer Rate', fieldName: 'NSSales_Final_Rate__c', type: 'text'},
            {label: 'Lane Status', fieldName: 'NSSales_Lane_Status__c', type: 'text'},
            {label: 'Estimated Volume', fieldName: 'NSSales_EstVolume__c', type: 'text'},
            {label: 'Current Volume', fieldName: 'NSSales_Committed_Volume__c', type: 'text'}
        ]);
